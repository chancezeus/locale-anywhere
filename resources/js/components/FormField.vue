                ...
                <div class="flex">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <span v-else>{{ __('NOT TRANSLATED') }}</span>
                        </p>

                        <p
                            class="text-sm"
                            v-if="field.value.isTranslated"
                            v-html="__('Item is translated in <strong>:locale</strong>. You are updating the translation.', {locale: currentLocaleName})"
                        ></p>

                        <p
                            class="text-sm"
                            v-else
                            v-html="__('Item is not translated in <strong>:locale</strong>. You are creating a translation.', {locale: currentLocaleName})"
                        ></p>
                    </div>
                </div>
            </div>
